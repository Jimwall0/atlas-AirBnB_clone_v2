...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, arg):
        ...
        # Prepare the dictionary for the keyword arguments (params)
        kwargs = {}
        ...
        for param in args[1:]:
            ...
            if len(key_val) == 2:
                ...
                # Handling string values (removing quotes and replacing underscores)
                if value.startswith('"') and value.endswith('"'):
                    value = value[1:-1].replace('_', ' ')  # Replace underscores with spaces
                    kwargs[key] = value
                ...
                # Handling float values
                    ...
                    continue  # Skip if it doesn't match any valid type

        # Create the new instance using the class and parameters
